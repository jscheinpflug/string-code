...
3. Employ principles of data-oriented design. Design your data structures first, then think how procedures transform them at maximal efficiency - only then write the logic. Keep your data structures lean. Each step in the program logic only has access to the data it requires without compromise. Never perform a redundant calculation.
