...
\[Beta]ghostbar[z_]:=R[exp\[Phi]tf[-1,z],\[Xi]t[1,z]];
...
PCO[z_]:=-1/2 R[exp\[Phi]f[1,z],Gmatter[z]]+R[c[0,z],\[Xi][1,z]]-1/2 R[exp\[Phi]b[2,z],\[Eta][1,z],b[0,z]]
-1/4 R[exp\[Phi]b[2,z],\[Eta][0,z],b[1,z]]-1/2 R[d\[Phi][0,z],exp\[Phi]b[2,z],\[Eta][0,z],b[0,z]];

PCObar[z_]:=-1/2 R[exp\[Phi]tf[1,z],Gmatterbar[z]]+R[ct[0,z],\[Xi]t[1,z]]-1/2 R[exp\[Phi]tb[2,z],\[Eta]t[1,z],bt[0,z]]
-1/4 R[exp\[Phi]tb[2,z],\[Eta]t[0,z],bt[1,z]]-1/2 R[d\[Phi]t[0,z],exp\[Phi]tb[2,z],\[Eta]t[0,z],bt[0,z]];
