...
BeginPackage["StringCode`Conventions`ConventionsIIBXi`"];
...
PCObar[z_]:=-1/2R[exp\[Phi]tf[1,z],Gmatterbar[z]]+R[ct[0,z],\[Xi]t[1,z]]-1/2R[exp\[Phi]tb[2,z],\[Eta]t[1,z],bt[0,z]]-1/4R[exp\[Phi]tb[2,z],\[Eta]t[0,z],bt[1,z]]-1/2R[d\[Phi]t[0,z],exp\[Phi]tb[2,z],\[Eta]t[0,z],bt[0,z]]
