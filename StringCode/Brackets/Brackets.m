...
rescaledR = mapOp[rescaling[q], rescaling[Conjugate[q]]][Ra];
...
rescaledOp = mapOp[rescaling[q], rescaling[Conjugate[q]]][Opa];
...
rescaledMultiOp = mapOp[rescaling[q], rescaling[Conjugate[q]]][MultiOpa];
