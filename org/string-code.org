:PROPERTIES:
:ID:       20260606T150003.000000
:END:
#+title: String-Code
#+auto_tangle: t
#+PROPERTY: header-args:zig :tangle ../src/root.zig :mkdirp yes

The root module exposes the two build-checked kernels.  Higher string modules
depend on these through their public APIs.
