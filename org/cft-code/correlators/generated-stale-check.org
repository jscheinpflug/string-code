:PROPERTIES:
:ID:       20260612T113500.000000
:END:
#+title: Generated CFT Stale Check
#+PROPERTY: header-args:zig :tangle ../../../src/cft-code/correlators/check_generated_hashes.zig :mkdirp yes

This build helper verifies generated Zig files without loading SBCL.  The Lisp
generator writes one =source-hash= comment per source file.  The helper recomputes
the same FNV-1a hash from disk and fails with a regeneration hint on mismatch.
