:PROPERTIES:
:ID:       20260606T211001.000000
:END:
#+title: Tensor Context
#+auto_tangle: t
#+PROPERTY: header-args:zig :tangle ../../src/tensor-code/context.zig :mkdirp yes

The context module is the procedural boundary of tensor-code.  Public callers
get an opaque state pointer and methods; the stores remain in a private
implementation record so callers cannot bypass validation.  Local formula
routes delegate reusable explicit projector programs to
[[id:20260608T001501.000000][Projector Constructor]].
